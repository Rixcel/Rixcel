...
<html lang="en">
  <head>
    <title>Del Luna&mdash; Toko Album dan Merchandise K-POP Online </title>
    <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="/home" class="js-logo-clone">Del Luna</a>
              </div>
            </div>
      ...
      <nav class="site-navigation text-right text-md-center" role="navigation">
        <div class="container">
          <ul class="site-menu js-clone-nav d-none d-md-block">
            ...
            <li class="{{ Request::path() === 'kontak' ? '' : '' }}"><a href="{{ route('user.kontak') }}">Kontak</a></li>
          </ul>
        </div>
      </nav>
    </header>
    ...
    <footer class="site-footer border-top">
          <div class="col-md-6 col-lg-6">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                <li class="address">Jalanan Bogor</li>
                <li class="phone"><a href="tel://23923929210">+62 8129 6496 311</a></li>
                <li class="email">Del Luna@gmail.com</li>
              </ul>
            </div>
          </div>
        </div>
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy;<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" class="text-primary">Rixcel</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
