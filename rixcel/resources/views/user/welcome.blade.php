@extends('user.app')
@section('content')
<div class="site-blocks-cover" style="background-image: url({{ asset('shopper') }}/images/KPop.jpg);" data-aos="fade">
    <div class="container">
    <div class="row align-items-start align-items-md-center justify-content-end">
        <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
        <h1 class="mb-2"><span style="color: white">Cari Barang Idola Kamu disini</span></h1>
        <div class="intro-text text-center text-md-left">
            <p class="mb-4"><span style="color: white">Album dan Merchandise disini terbukti asli!!!</span></p>
            <p>
