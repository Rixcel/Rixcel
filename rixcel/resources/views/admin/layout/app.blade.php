...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{ asset('adminassets') }}/assets/images/deluna.png" />
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <div class="nav-profile-text">
                  <p class="mb-1 text-black">Admin Del Luna</p>
                </div>
              </a>
          ...
          <ul class="nav">
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                  <span class="font-weight-bold mb-2">Del Luna</span>
            ...
            <li class="nav-item ">
              ...
              <div class="collapse" id="ui-basic1">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.pelanggan') }}">Pelanggan</a></li>
                  <li class="nav-item"> <a class="nav-link {{ Request::path() === 'admin/listkeranjang' ? 'active' : '' }}" href="{{ route('admin.listkeranjang') }}">List Keranjang</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item ">
            ...
            <li class="nav-item ">
              ...
              <div class="collapse" id="ui-basic2">
                ...
                <li class="nav-item"> <a class="nav-link {{ Request::path() === 'admin/listkontak' ? 'active' : '' }}" href="{{ route('admin.listkontak') }}">List Contact</a></li>
                </ul>
              </div>
            </li>
          </ul>
